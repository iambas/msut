...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onFacebookClicked(View view){
        if (!(new NetWork(view.getContext()).isNetworkAvailiable())){
    ...
    private void getProfile(){
        ...
        db.child(USER).child(uid).setValue(new User(profile.getName(), photo));
    ...
    private void checkLogin(){
        ...
        boolean isNet = new NetWork(this).isNetworkAvailiable();
        if (!isNet){
